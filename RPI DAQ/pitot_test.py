...
location = "/home/pi/Documents/data/"
filename = "CALIBRATION_" + current_time + ".txt"
filestring = location + filename
calfile = open(filestring,'w')

print("Beginning calibration sequence...")

cal_sample = int(input('Number of calibration samples to collect:'))
